...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        # output of conv layer: (N, F, H', W'), prod(F, H', W') = 
        W2_row_size = num_filters * input_dim[1]/2 * input_dim[2]/2
        self.params['W2'] = weight_scale * np.random.randn(int(W2_row_size), hidden_dim)
    ...
    def loss(self, X, y=None):
        ...
        dX, dW1, db1 = conv_relu_pool_backward(dh2, cache1)
